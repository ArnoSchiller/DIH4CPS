"""
StreamCapture: This module captures the frame from the video stream and saves them into the ring buffer.
...
v0.0.1      Copied and adapted webcam capture.                      04-12-2020\n
"""
import platform
...
class StreamCapture:
    ...
    device_name : 
    """
    connection_str = global_stream_connection
    frame_width = 0 
    frame_height = 0 
...
if __name__ == "__main__":
    sc = StreamCapture(None)
    print("Result test capture:", sc.capture_test_frame())
